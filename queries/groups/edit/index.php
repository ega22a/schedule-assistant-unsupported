<?php
    ...
    if ($isAuth) {
        ...
        echo '
            ...
            <h1 class="not-selected">Добавить группы</h1>';
        ...
        if ($i == 0) {
            echo '
                ...
                <p class="wall-text not-selected">Прежде чем добавлять группы, добавьте корпуса!</p>
                <p class="wall-text not-selected">Также, если нужные группы находятся в архиве, то вытащите их.</p>
            ';
        }
        else {
