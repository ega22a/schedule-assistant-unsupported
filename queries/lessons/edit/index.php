<?php
    ...
    if ($isAuth) {
        ...
        echo '
            ...
            <h1 class="not-selected">Добавить дисциплины</h1>';
        ...
        while ($row = $result -> fetch_assoc()) {
            ...
            <div class="card" id="c-' . $i . '" style="opacity: 1;" db="' . $row['id'] . '">
                <div class="input">
                    <input type="text" placeholder="Короткое наименование" value="' . $row['shortName'] . '">
                    <span></span>
                </div>
                <div class="input">
                    <input type="text" placeholder="Полное наименование" value="' . $row['fullName'] . '">
                    <span></span>
                </div>
        ...
        echo '
	        <div class="card new-card not-selected">
		        <span></span>
		        <p>Добавить ещё одну дисциплину</p>
	        </div>
