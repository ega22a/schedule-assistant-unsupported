...
$(document).ready(function(){
    $('.new-card').click(function(){
        ...
        if (ifExsist) {
            card.innerHTML = '<div class="input"><input type="text" placeholder="Короткое наименование"><span></span></div><div class="input"><input type="text" placeholder="Полное наименование"><span></span></div><input type="button" onclick="DelSomething(\'' + card.id + '\');" value="Удалить">';
        }
        else {
            card.innerHTML = '<div class="input"><input type="text" placeholder="Короткое наименование"><span></span></div><div class="input"><input type="text" placeholder="Полное наименование"><span></span></div><input type="button" onclick="DelSomething(\'c-' + i + '-' + i + '\');" value="Удалить">';
        }
